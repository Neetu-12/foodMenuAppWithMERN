...
export const Navbar = () => {
    ...
    const selectMenu = (foodtype) => {
        if (sessionStorage.getItem("foodtype")) { // token get
            ...
            navigate('/foodMenuAppWithMERN/Dynamic')
        }
        else {
            sessionStorage.setItem("foodtype", foodtype)
            navigate('/foodMenuAppWithMERN/Dynamic')
            ...
            <div className='Navbar'>
                <div className="Navbar-Content">
                    ...
                    <div className="main-home-page">
                        <a href='/foodMenuAppWithMERN' className="home-page">Home</a>
                    </div>
                    ...
                    <div className='links'>
                        ...
                        {validator.multiple.userName ? <>
                            ...
                            <a href="/foodMenuAppWithMERN/Signup" className='nav1'>Signup</a>
                            <a href="/foodMenuAppWithMERN/Signin" className='nav1'>Signin</a>
                        </>}
